# AIR-020T
Al Inference System Based on NVIDIA Jetson™ TX2 NX
NVIDIA.
WISE-DeviceOn
CE FCC
====================
...
" NVIDIA® Jetson™ TX2 NX embedded SoM
· Multiple 10 ports: Dual LAN, DIO, COM, 2x USB 3.2 Type A and USB type C
· M.2 2280 128GB storage built-in
· Edge Al Suite Al Utility Support for pre-trained models and deep learning
· Linux Ubuntu 18.04 LTS and NVIDIA JetPack 4.5.1 preload
· - 10~55 ℃ operating temperature and 12-24V power input
· IP40 Design compliance
· Qualified for Edge AI SRP of WISE-DeviceOn
ÈdgeAl Suite
NVIDIA. CUDA
====================
### AIR-020T - Specifications - Processor System :
```json
[{'CPU': 'Denver 2 CPU and Cortex A57 Quad Core, Max. 2.0 GHZ'}, {'GPU': '256 NVIDIA® CUDA® cores'}, {'AI Performance Reference': 'Up to 1.33 TFLOPS'}, {'Memory': '4 GB LPDDR4'}, {'Flash': '16G eMMC 5.1'}]
```
====================
### AIR-020T - Specifications - Ethernet :
```json
[{'Interface': 'RJ-45'}, {'Controller': 'Intel® i210AT, NVIDIA SoM'}, {'Speed': '2 x Gigabit Ethernet (10/100/1000 Mbps)'}]
```
====================
### AIR-020T - Specifications - Display :
```json
[{'HDMI': '1 x HDMI (Max. resolution 3840 × 2160 @ 60Hz)'}]
```
====================
### AIR-020T - Specifications - IO Ports :
```json
[{'USB': '2 x USB 3.2 Type A 1 x USB 3.2 Type C'}, {'OTG USB': '1 x Micro USB (only for system recovery)'}, {'DI/DO': '8 bit'}, {'COM': '1 x RS-232/422/485, 1 x RS-232/422/485 (option, by cable)'}]
```
====================
### AIR-020T - Specifications - Expansion :
```json
[{'MiniPCIe': '1 x Full-size mPCIE with Nano SIM slot (USB/PCIe signal)'}]
```
====================
### AIR-020T - Specifications - Storage :
```json
[{'M.2 storage': '1 x M.2 2280 (M Key) 128GB built-in'}]
```
====================
### AIR-020T - Specifications - Power :
```json
[{'Power Supply': 'Power adaptor 65W, optional'}, {'Power Type': 'ATX/AT support, ATX default'}]
```
====================
### AIR-020T - Specifications - Environment :
```json
